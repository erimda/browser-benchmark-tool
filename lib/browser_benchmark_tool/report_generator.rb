...
module BrowserBenchmarkTool
  class ReportGenerator
    ...
    def export_csv
      ...
      headers = %w[level attempted successful failed error_rate p50 p95 p99 cpu_usage
                   memory_usage]
    ...
    def save_reports
      ...
      @chart_generator.save_charts if config.output[:generate_charts] && @chart_generator
